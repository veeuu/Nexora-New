            ...
            {filteredData.map((row, index) => {
              ...
              return (
                <tr key={index} style={{ backgroundColor: isHighlighted ? '#fefce8' : 'transparent' }}>
                  ...
                  <td onMouseEnter={(e) => handleMouseEnter(e, row.fundName)} onMouseLeave={handleMouseLeave}>
                    {highlightText(row.fundName, searchTerm)}
                  </td>
                  <td onMouseEnter={(e) => handleMouseEnter(e, row.holding)} onMouseLeave={handleMouseLeave}>
                    {highlightText(row.holding, searchTerm)}
                  </td>
