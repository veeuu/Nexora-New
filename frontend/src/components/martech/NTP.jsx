          ...
          {activeFilterMenu === 'companyName' && (
            <div className="ntp-filter-button-wrapper">
              ...
              <div className="ntp-filter-dropdown-wrapper">
                ...
                {(() => {
                  const allFiltered = getUniqueOptions('companyName').filter(option => {
                    ...
                    <>
                      {visible.map((option, idx) => {
                        ...
                        return (
                          ...
                          >
                            <input type="checkbox" checked={isSelected} onChange={() => {}} className="ntp-filter-option-checkbox" />
                            {option}
                          </div>
                        );
                      })}
                      ...
                      {allFiltered.length === 0 && (
                        <div style={{ padding: '10px 12px', textAlign: 'center', color: '#999', fontSize: '13px' }}>No companies found</div>
                      )}
                    </>
                  );
                })()}
